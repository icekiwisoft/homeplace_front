...
export default function ArticlePostDialog({
  ...
  const renderSteppers = () =>
    Array.from({ length: totalSteps }, (_, i) => (
      <span
        key={i}
        className={`size-8 inline-flex items-center justify-center rounded-full mr-2 ${
          currentStep === i + 1
          ...
          <div className='py-3'>
            ...
            <div className='flex items-center justify-center w-full'>
              <label
                ...
                className='flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 relative overflow-hidden'
              >
            ...
            {formData.medias.length > 0 && (
              <div className='flex flex-col mt-4 justify-center w-full'>
                <span className='text-gray-500 text-[12px] mb-1 text-center'>
                  Cliquer sur le media de couverture 🛈
                </span>
              ...
              <Listbox value={selectedPeriod} onChange={setSelectedPeriod}>
                <div className='relative mt-1'>
                  <Listbox.Button className='relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left border border-gray-300'>
                    <span className='block truncate'>
                      {selectedPeriod ? selectedPeriod.name : 'Select a Type'}
                    </span>
                    <span className='pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2'>
                      <HiChevronUpDown className='h-5 w-5 text-gray-400' />
                    </span>
