  ...
  const content = (
    <div className="md:hidden text-black bg-white h-screen absolute z-[3] top-[64px] w-full left-0 right-0 transition">
      <ul className="text-center text-xs mt-10 z-[50000] transition-all">
        ...
        {/* Section Favoris */}
        <NavLink to="/favorite">
          <button className="my-2 py-2 hover:bg-gray-200 hover:rounded active:bg-violet-700 inline-flex justify-center gap-2 items-center">
            <HeartIcon className="h-6" /> Favoris
          </button>
        </NavLink>
        {/* Section Dashboard */}
        {user && (
