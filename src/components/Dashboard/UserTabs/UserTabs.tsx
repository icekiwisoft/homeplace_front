...
function AnnounceCard(props: Product | undefined): React.ReactElement {
    return (
        <div className="shadow-md rounded-lg cursor-pointer overflow-hidden  bg-white ">
            <div className="h-48 ">
...
function MediaCard(props: Product | undefined): React.ReactElement {
    return (
        <div className="shadow-md rounded-md cursor-pointer aspect-square overflow-hidden bg-white ">
                <img className='object-cover min-h-full min-w-full ' src={defaultHouseImg} />
