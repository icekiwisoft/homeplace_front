...
export default function FurniturePostDialog({ open, handler }) {
                ...
                <div className="mt-4 min-h-[300px]">
                    {
                        ...
                        <>
                            <div className="grid gap-6">
                                <Input label="kitchen" type="text" />
                                <Input label="kitchen" type="number" />
                    ...
                    }
                    {
                        activeStep === 1 && <div className="grid gap-6">
                            <Input label="room" size="lg" type="number" />
                            <Input label="bathroom" type="number" />
                            <Input label="pallor" type="number" />
                            <Input label="kitchen" type="number" />
                        </div>
                    }
