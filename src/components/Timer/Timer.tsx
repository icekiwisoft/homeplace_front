        ...
        <div className="text-center mx-auto w-96 py-4 px-4">
            <div className="flex items-center justify-center w-full lg:gap-8 sm:gap-5 gap-1 count-down-main">
                <div className="timer">
                    ...
                    <p className=" lg:text-sm text-xs font-normal text-gray-700 mt-1 text-center w-full">jours</p>
                </div>
                ...
                <div className="timer">
                    ...
                    <p className=" lg:text-sm text-xs font-normal text-gray-700 mt-1 text-center w-full">heures</p>
                </div>
                <h3 className="font-manrope font-semibold text-xl text-gray-700">:</h3>
                <div className="timer">
                    <div className="pl-1.5 pr-0 py-1 rounded relative bg-orange-50 w-max before:contents-[''] before:absolute before:h-full before:w-0.5 before:top-0 before:left-1/2 before:-translate-x-1/2 before:bg-white before:z-10">
                    ...
                    <p className=" lg:text-sm text-xs font-normal text-gray-700 mt-1 text-center w-full">minutes</p>
                </div>
                <h3 className="font-manrope font-semibold text-xl text-gray-700">:</h3>
                <div className="timer">
                    <div className="pl-1.5 pr-0 py-1 rounded relative bg-orange-50 w-max before:contents-[''] before:absolute before:h-full before:w-0.5 before:top-0 before:left-1/2 before:-translate-x-1/2 before:bg-white before:z-10">
                    ...
                    <p className=" lg:text-sm text-xs font-normal text-gray-700 mt-1 text-center w-full">secondes</p>
                </div>
            </div>
        </div>
    );
