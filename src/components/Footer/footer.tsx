...
export default function Footer(): React.ReactElement {
  return (
    <footer className="bg-gray-900 w-full text-white lg:px-48 pt-7 pr-10 pb-1 pl-14 relative">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="mb-4 md:mb-0">
          <h2 className="text-2xl font-semibold flex py-2">
            D <HiHomeModern className="h-auto" /> milis
          </h2>
        ...
        <div>
          ...
          <ul className="text-[16px] my-4">
            ...
            <li className="my-5 text-[16px]">Email: domilis@gmail.com</li>
            <li className="my-5 text-[16px]">Phone: +237 610101010 </li>
          </ul>
        </div>
        <div className="pl-8">
      ...
      <span className="w-fit mt-4 mx-auto flex justify-center h-9 text-white text-[16px] items-center">
        Developpé par ICEKIWI. Tous droits réservés © 2023
      </span>
    </footer>
  );
}
