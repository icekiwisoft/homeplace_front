...
export default function Announcer() {
  ...
  const options = ['announces', 'about', 'parametre'];
    ...
    <>
      ...
      <div className=' px-2 bg-gray-200 py-20 sm:py-28 xl:px-40 lg:px-28 md:px-10 '>
        ...
        <header className='rounded-xl relative bg-white overflow-hidden items-center justify-between mb-3 sm:mb-8'>
          <div className='h-40 sm:h-80 bg-gray-600 '>
        ...
        <div className='flex justify-center gap-1 mb-8  '>
          ...
          >
            <MdOutlineCampaign size={28} className='-rotate-45' />{' '}
            <span className='hidden lg:block'>Annonces</span>
          </button>
        </div>
        {option === 'announces' && (
          <>
