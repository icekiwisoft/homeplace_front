...
import { FaBed, FaDraftingCompass, FaHeart, FaLock, FaShareAlt, FaShower } from "react-icons/fa";
import { HiAcademicCap, HiLockClosed, HiOutlineHeart, HiOutlineLockClosed, HiOutlineShare } from "react-icons/hi2";
import { MdBed, MdOutlineCompassCalibration, MdOutlineShower, MdRule, MdSick } from "react-icons/md";
    ...
    <>
      ...
      <div className="px-2 sm:px-6 md:px-6 lg:px-10 bg-gray-200 mt-16 py-5">
        ...
        <div className="relative  bg-none">
          ...
          <button className="max-w-44 px-3 truncate border  py-1.5 rounded-xl text-sm bg-white border-gray-600 absolute bottom-3 right-3" onClick={toggleModal}>
