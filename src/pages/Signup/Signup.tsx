    ...
    <div className='flex h-screen bg-gray-300'>
      <div className='bg-white px-12   w-96  flex'>
        <div className=' w-full m-auto '>
          <h2 className='text-[1.1rem] font-semibold text-gray-800 text-2xl  '>WELCOME TO DOMILIX</h2>
          <span className='text-[0.9rem] text-gray-500 ' >Create your account  </span>
          <form action="" className=' w-full'>
            ...
            <div className='mt-5'>
              <input className='p-2  rounded-md bg-gray-100 outline-none  w-full' placeholder='email' type='email' />
            </div>
            <div className='mt-5'>
              <input className='p-2  rounded-md bg-gray-100 outline-none  w-full' placeholder='phone' type='number' />
            </div>
